    ...
    try {
      switch (method) {
        case 'credit_card': {
          ...
          const creditCardResponse = await axiosInstance.post('/payments/credit-card', {
            amount,
            ticketId,
        ...
        case 'COD': {
          // Tạo thanh toán COD
          const codResponse = await axiosInstance.post('/payments/cod', {
            amount,
            ticketId,
            returnUrl: `${window.location.origin}/payment-success`
          });
        ...
        case 'qr_code': {
          ...
          const qrResponse = await axiosInstance.post('/payments/create-qr', {
            amount,
            ticketId,
        ...
        case 'momo': {
          // Tạo thanh toán Momo
          const momoResponse = await axiosInstance.post('/payments/momo', {
            amount,
            ticketId,
            returnUrl: `${window.location.origin}/payment-success`,
            reservationId,
        ...
        case 'vnpay': {
          ...
          const vnpayResponse = await axiosInstance.post('/payments/vnpay', {
            amount,
            ticketId,
            returnUrl: `${window.location.origin}/payment-success`,
            reservationId,
